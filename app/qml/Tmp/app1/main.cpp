...
#include "src/viewotcepsmodel.h"
#include "src/editotcepsmodel.h"
#include "src/mvp_import.h"
#include "src/kbdllhooks.h"
...
//    });
    ...
    Management &model1 = Management::instance();
    QQmlApplicationEngine engine;
    engine.addImportPath(":/qml");

    QQmlContext* context = engine.rootContext();
        context->setContextProperty("otcepsModel1", &model);
        context->setContextProperty("otcepsModel", &model1);
